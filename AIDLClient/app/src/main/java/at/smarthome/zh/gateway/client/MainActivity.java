package at.smarthome.zh.gateway.client;
...
import at.smarthome.aidl.IAdd;
import at.smarthome.aidl.Person;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
	...
	private String serverAppUri = "at.smarthome.zh.gateway.server";
	...
	private void initConnection() {
		if (addService == null) {
			...
			intent.setPackage("at.smarthome.zh.gateway.server");
